...
function ClientRole() {
    return (
        ...
        strategy="lazyOnload">
            <h3 className="opacity-50 font-mono">The world’s leading online businesses trust Ravelin to manage risk</h3>
            <div className="grid grid-cols-2 lg:grid-cols-6 px-10">
